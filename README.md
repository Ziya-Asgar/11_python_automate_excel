...
- accessing the active sheet in the file with `<workbook>.active`,
- reading and writing to a workbook by accessing specific cells,
- writing to a workbook using the `<worksheet>.append` method,
- saving the workbook,
...
- accessing specific columns in a sheet with the help of the `get_column_letter` function,
